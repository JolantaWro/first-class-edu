...
const wordExercises: WordExercise[] = [
  ...
  { word: "p", options: ["a", "k", "p", "l"], correctIndex: 2, image: "" },
  { word: "q", options: ["g", "o", "q", "p"], correctIndex: 2, image: "" },
  { word: "r", options: ["d", "p", "r", "f"], correctIndex: 2, image: "" },
  { word: "s", options: ["p", "d", "s", "c"], correctIndex: 2, image: "" },
  { word: "t", options: ["r", "t", "k", "i"], correctIndex: 1, image: "" },
  { word: "u", options: ["o", "u", "a", "e"], correctIndex: 1, image: "" },
  { word: "v", options: ["w", "v", "u", "y"], correctIndex: 1, image: "" },
  { word: "w", options: ["m", "n", "w", "v"], correctIndex: 2, image: "" },
  { word: "x", options: ["x", "k", "z", "t"], correctIndex: 0, image: "" },
  { word: "y", options: ["i", "u", "y", "e"], correctIndex: 2, image: "" },
